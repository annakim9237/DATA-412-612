...
```{r}
pop <- read.csv("new-data/Population by Age and Sex - US, States, Counties.csv")

#names(pop)

pop_df <- pop %>%
  select(Description, Year, 
         Population_18_54 = "Population.18.54", 
         Population_55_plus = "Population.55.", 
         Population_65_plus = "Population.65.", 
         Population_Under_18 = "Population.Under.18", 
         Population_0_4 = "Population.0.4") %>%
